    ...
    <div className="min-h-screen pt-32 pb-20">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose dark:prose-invert max-w-none space-y-6 text-slate-600 dark:text-slate-300">
          ...
          <h2 className="text-2xl font-semibold text-slate-900 dark:text-white">Use License</h2>
          ...
          <h2 className="text-2xl font-semibold text-slate-900 dark:text-white">Disclaimer</h2>
          ...
          <h2 className="text-2xl font-semibold text-slate-900 dark:text-white">Limitations</h2>
          <p>In no event shall we be liable for any damages arising out of or in connection with the use of this website.</p>

          <h2 className="text-2xl font-semibold text-slate-900 dark:text-white">Revisions</h2>
